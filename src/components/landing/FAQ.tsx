...
const faqs = [
  { q: "What is Dequeue?", a: "Dequeue is a retail technology company that builds infrastructure to eliminate checkout queues. We offer four products — Go (mobile checkout), Bite (restaurant ordering), Swift (smart carts), and Hermit (autonomous dark stores)." },
