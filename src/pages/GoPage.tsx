    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-24 overflow-hidden" ref={heroRef}>
        <div className="absolute inset-0 pointer-events-none">
          <Sparkles className="w-full h-full" density={60} size={1.4} speed={0.4} color="hsl(262 83% 58%)" opacity={0.2} />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
              ...
              <h1 className="text-5xl lg:text-7xl font-bold font-heading mb-6 leading-[1.05]">
                Mobile Checkout.{" "}
                <span className="gradient-text">No Lines.</span>
              </h1>
              <p className="text-lg text-muted-foreground leading-relaxed mb-8 max-w-lg">
                Go is a software-only retail checkout system that turns any smartphone into a checkout terminal.
                Customers simply scan products, pay instantly, and walk out.
              </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
            {useCases.map((uc, i) => (
              <motion.div
                ...
                className="flex items-center gap-3 liquid-glass-card p-4"
              >
